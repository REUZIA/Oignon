...
SLEEP_ENABLED= const(0b1) # sera en sleep mode 
SLEEP_DISABLED = const(0b0) # ne sera pas en sleep mode
...
class ICM20948:
    ...
    **Quickstart: Importing and using the device**
    ...
    def sleep(self) -> str:
        ...
        | Mode                               | Value                                                |
        +====================================+======================================================+
        | :py:const:`icm20948.SLEEP_ENABLED`  | :py:const:`0b0`                       on            |
        +------------------------------------+------------------------------------------------------+
        | :py:const:`icm20948.SLEEP_DISABLED` | :py:const:`0b1`                       disabled      |
        +------------------------------------+------------------------------------------------------+

        """
        values = {0: "SLEEP_DISABLED", 1: "SLEEP_ENABLED"}
        return values[self._sleep]
